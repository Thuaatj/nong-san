...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-green-950 overflow-hidden">
      ...
      {/* OVERLAY */}
      <div className="absolute inset-0 bg-gradient-to-t from-green-950 via-green-900/90 to-transparent" />

      {/* GLOW */}
      <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-green-500/10 blur-[120px]" />

      {/* CONTENT */}
      <div className="relative max-w-7xl mx-auto px-6 py-20 md:py-32 text-white">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-20">
          ...
          >
            ...
            <div className="space-y-4 text-base md:text-lg opacity-90">
              ...
              <div className="flex items-center gap-4">
                ...
                nutscornervn@gmail.com
              </div>

              <div className="flex items-start gap-4">
                <MapPin className="w-5 h-5 text-green-400 mt-1" />
                <span>
                  163/11 Vườn Lài, P. An Phú Đông,<br />
                  Q.12, TP.HCM
                </span>
              </div>

              <p className="text-sm opacity-70">
                ĐKKD 0315784541 – cấp 16/07/2019
              </p>
            </div>
          </motion.div>
          ...
          >
            {/* LOGO BADGE */}
            <div className="relative w-44 h-44 md:w-56 md:h-56 rounded-full bg-white/10 backdrop-blur-xl border border-green-400/30 shadow-2xl">
              <Image
              ...
              />
              <Leaf className="absolute -top-4 -right-4 w-12 h-12 text-green-400 opacity-80" />
            </div>
            ...
            <ul className="space-y-5 text-center">
              {policies.map((p, i) => (
                <motion.li
                  ...
                  className="flex items-center justify-center gap-4 text-sm md:text-base opacity-90"
                >
          ...
          >
            ...
            <motion.a
              ...
              className="flex items-center gap-4 bg-red-600 hover:bg-red-500 px-10 py-5 rounded-full shadow-2xl text-lg font-semibold"
            >
              <Image
      ...
      {/* COPYRIGHT */}
      <div className="relative text-center py-6 text-sm text-white/60 border-t border-white/10">
